...
{
    public partial class Team55LibraryContext : DbContext
    {
        public Team55LibraryContext()
        {
        }

        public Team55LibraryContext(DbContextOptions<Team55LibraryContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1067292;Password=password123;Database=Team55Library");
            }
        }
